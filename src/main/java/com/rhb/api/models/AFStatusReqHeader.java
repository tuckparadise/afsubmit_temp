...
public class AFStatusReqHeader {
    ...
    public AFStatusReqHeader sourceID(String sourceID) {
    ...
    public AFStatusReqHeader destQueueManager(String destQueueManager) {
    ...
    public AFStatusReqHeader loginID(Integer loginID) {
    ...
    public AFStatusReqHeader recordLength(Integer recordLength) {
    ...
    public AFStatusReqHeader errorMessage(String errorMessage) {
    ...
    public AFStatusReqHeader errorCode(Integer errorCode) {
    ...
    public AFStatusReqHeader terminalID(String terminalID) {
    ...
    public AFStatusReqHeader trxnDate(String trxnDate) {
    ...
    public AFStatusReqHeader trxnTime(String trxnTime) {
    ...
    public AFStatusReqHeader replyRefNo(String replyRefNo) {
    ...
    public AFStatusReqHeader dplName(String dplName) {
    ...
    public AFStatusReqHeader extTrxnCd(String extTrxnCd) {
    ...
    public AFStatusReqHeader destQueue(String destQueue) {
    ...
    public AFStatusReqHeader msgRefNo(String msgRefNo) {
    ...
    public AFStatusReqHeader systemStatus(String systemStatus) {
    ...
    public AFStatusReqHeader msgverNo(Double msgverNo) {
    ...
    public AFStatusReqHeader filler(String filler) {
        this.filler = filler;
        return this;
    }
    ...
    public AFStatusReqHeader noOfRecords(Integer noOfRecords) {
    ...
    public AFStatusReqHeader pan(String pan) {
        this.pan = pan;
        return this;
    }
    ...
    public AFStatusReqHeader overrideTellerId(Integer overrideTellerId) {
    ...
    public boolean equals(Object o) {
        ...
        AFStatusReqHeader afStatusReqHeader = (AFStatusReqHeader) o;
        return Objects.equals(this.sourceID, afStatusReqHeader.sourceID) &&
                Objects.equals(this.destQueueManager, afStatusReqHeader.destQueueManager) &&
                Objects.equals(this.loginID, afStatusReqHeader.loginID) &&
                Objects.equals(this.recordLength, afStatusReqHeader.recordLength) &&
                Objects.equals(this.errorMessage, afStatusReqHeader.errorMessage) &&
                Objects.equals(this.errorCode, afStatusReqHeader.errorCode) &&
                Objects.equals(this.terminalID, afStatusReqHeader.terminalID) &&
                Objects.equals(this.trxnDate, afStatusReqHeader.trxnDate) &&
                Objects.equals(this.trxnTime, afStatusReqHeader.trxnTime) &&
                Objects.equals(this.replyRefNo, afStatusReqHeader.replyRefNo) &&
                Objects.equals(this.dplName, afStatusReqHeader.dplName) &&
                Objects.equals(this.extTrxnCd, afStatusReqHeader.extTrxnCd) &&
                Objects.equals(this.destQueue, afStatusReqHeader.destQueue) &&
                Objects.equals(this.msgRefNo, afStatusReqHeader.msgRefNo) &&
                Objects.equals(this.systemStatus, afStatusReqHeader.systemStatus) &&
                Objects.equals(this.msgverNo, afStatusReqHeader.msgverNo) &&
                Objects.equals(this.filler, afStatusReqHeader.filler) &&
                Objects.equals(this.noOfRecords, afStatusReqHeader.noOfRecords) &&
                Objects.equals(this.pan, afStatusReqHeader.pan) &&
                Objects.equals(this.overrideTellerId, afStatusReqHeader.overrideTellerId);
    }
